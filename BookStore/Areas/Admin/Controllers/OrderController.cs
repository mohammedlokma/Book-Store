...
namespace BookStore.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Details(int id)
        {
            ...
            {
                OrderHeader = _unit.OrderHeader.GetFirstOrDefault(
                u => u.Id == id, includeProperties: "ApplicationUser"),
                
                OrderDetails = _unit.OrderDetails.GetAll(o=>o.OrderId == id,
        ...
        {
            OrderHeader orderHeader = _unit.OrderHeader.GetFirstOrDefault(u => u.Id == OrderVM.OrderHeader.Id,
        ...
        {
            OrderHeader orderHeader = _unit.OrderHeader.GetFirstOrDefault(
                u => u.Id == id);
        ...
        public IActionResult GetOrderList(string status)
        {
            ...
            {
                orderHeaderList = _unit.OrderHeader.GetAll(includeProperties: "ApplicationUser");
            }
            else
            {
                orderHeaderList = _unit.OrderHeader.GetAll(
