...
namespace BookStore.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public CartController(IUnitOfWork unit, IEmailSender email, UserManager<IdentityUser> userManager
        ...
        public IActionResult Index()
        {
            ...
            ShoppingCartVM.OrderHeader.ApplicationUser = _unit.ApplicationUser
        ...
        {
            var cart = _unit.ShoppingCart.GetFirstOrDefault
        ...
        public IActionResult Minus(int cartId)
        {
            ...
            if (cart.Count == 1)
            {
                var cnt = _unit.ShoppingCart.GetAll(u => u.ApplicationUserId ==
        ...
        public IActionResult Summary()
        {
            ...
            {
                OrderHeader = new Models.OrderHeader(),
                ListCart = _unit.ShoppingCart.GetAll(c => c.ApplicationUserId == claim.Value,
        ...
        public IActionResult SummaryPost(string stripeToken)
        {
            ...
            ShoppingCartVM.OrderHeader.ApplicationUser =
                _unit.ApplicationUser.GetFirstOrDefault(
                    u => u.Id == claim.Value, includeProperties: "Company");

            ShoppingCartVM.ListCart = _unit.ShoppingCart.GetAll(
            ...
            foreach(var item in ShoppingCartVM.ListCart)
            {
                item.Price = SD.GetPriceBasedOnQuantity(item.Count,
                    item.Product.Price, item.Product.Price50,
            ...
            if(stripeToken == null)
            {
                //order will be created for delayed payment for authorized comapny
        ...
        public IActionResult OrderConfirmation( int id)
        {
            ...
            try
            {
                var message = MessageResource.Create(
                     body: "Your Order Placed on Book Store. Your Order ID:" + id,
